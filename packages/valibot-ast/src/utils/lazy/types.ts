import type { GenericSchema, GenericSchemaAsync, LazySchema, LazySchemaAsync } from "valibot";

export type GenericLazySchema = LazySchema<GenericSchema>;
export type GenericLazySchemaAsync = LazySchemaAsync<GenericSchema | GenericSchemaAsync>;
