...
export type GenericWrappedSchemaAsync =
  | ExactOptionalSchemaAsync<GenericSchema | GenericSchemaAsync, DefaultAsync<GenericSchemaAsync, null | undefined>>
  | NonNullableSchemaAsync<GenericSchema | GenericSchemaAsync, ErrorMessage<NonNullableIssue> | undefined>
  | NonNullishSchemaAsync<GenericSchema | GenericSchemaAsync, ErrorMessage<NonNullishIssue> | undefined>
  | NonOptionalSchemaAsync<GenericSchema | GenericSchemaAsync, ErrorMessage<NonOptionalIssue> | undefined>
  | NullableSchemaAsync<GenericSchema | GenericSchemaAsync, DefaultAsync<GenericSchemaAsync, null | undefined>>
  | NullishSchemaAsync<GenericSchema | GenericSchemaAsync, DefaultAsync<GenericSchemaAsync, null | undefined>>
  | OptionalSchemaAsync<GenericSchema | GenericSchemaAsync, DefaultAsync<GenericSchemaAsync, null | undefined>>
  | UndefinedableSchemaAsync<GenericSchema | GenericSchemaAsync, DefaultAsync<GenericSchemaAsync, null | undefined>>
...
type RequiredFlag<
  TSchema extends GenericSchema | GenericSchemaAsync,
> = TSchema extends ExactOptionalSchema<any, any> | ExactOptionalSchemaAsync<any, any>
  ? false
...
type NullableFlag<
  TSchema extends GenericSchema | GenericSchemaAsync,
> = TSchema extends NonNullableSchema<any, any> | NonNullableSchemaAsync<any, any>
  ? false
