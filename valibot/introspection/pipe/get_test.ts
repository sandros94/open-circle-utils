...
Deno.test("getPipeActions - Get all actions", () => {
  ...
  assertEquals(
    actions.some((a) => a.type === "email"),
    true,
  );
  assertEquals(
    actions.some((a) => a.type === "min_length"),
    true,
  );
  assertEquals(
    actions.some((a) => a.type === "max_length"),
    true,
  );
});
...
Deno.test("findPipeItems - Find by kind", () => {
  ...
  assertEquals(
    items.every((i) => i.kind === "validation"),
    true,
  );
});
...
Deno.test("getTransformationActions - Get transformation actions", () => {
  ...
  assertEquals(
    actions.some((a) => a.type === "trim"),
    true,
  );
  assertEquals(
    actions.some((a) => a.type === "to_upper_case"),
    true,
  );
});
...
Deno.test("getLengthActions - Get length constraint actions", () => {
  ...
  assertEquals(
    actions1.some((a) => a.type === "min_length"),
    true,
  );
  assertEquals(
    actions1.some((a) => a.type === "max_length"),
    true,
  );
...
Deno.test("getValueActions - Get value constraint actions", () => {
  ...
  assertEquals(actions1.length, 2);
  assertEquals(
    actions1.some((a) => a.type === "min_value"),
    true,
  );
  assertEquals(
    actions1.some((a) => a.type === "max_value"),
    true,
  );
  assertEquals(actions2.length, 1);
...
Deno.test("getSizeActions - Get size constraint actions", () => {
  ...
  assertEquals(actions1.length, 2);
  assertEquals(
    actions1.some((a) => a.type === "min_size"),
    true,
  );
  assertEquals(
    actions1.some((a) => a.type === "max_size"),
    true,
  );
  assertEquals(actions2.length, 1);
...
Deno.test("getBytesActions - Get bytes constraint actions", () => {
  ...
  assertEquals(actions1.length, 2);
  assertEquals(
    actions1.some((a) => a.type === "min_bytes"),
    true,
  );
  assertEquals(
    actions1.some((a) => a.type === "max_bytes"),
    true,
  );
  assertEquals(actions2.length, 1);
