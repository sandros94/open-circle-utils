...
export type GenericArraySchema = ArraySchema<GenericSchema, ErrorMessage<ArrayIssue> | undefined>;
...
export type GetArrayItem<TSchema extends GenericSchema | GenericSchemaAsync> = TSchema extends
  | GenericArraySchema
  | GenericArraySchemaAsync
  ? TSchema["item"]
  : null;

export type GetTupleItems<TSchema extends GenericSchema | GenericSchemaAsync> = TSchema extends
  | GenericTupleSchema
